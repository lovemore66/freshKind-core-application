...
<h3>Total: ${cart.items.reduce((total, item) => total + item.price, 0).toFixed(2)}</h3>
 ...
 {/* update */}
  ...
  <div>
    ...
    <input name="title" placeholder="Title" value={editingProduct.title} onChange={(e) => setEditingProduct({ ...editingProduct, title: e.target.value })} />
    <input name="price" type="number" placeholder="Price" value={editingProduct.price} onChange={(e) => setEditingProduct({ ...editingProduct, price: parseFloat(e.target.value) })} />
    <button onClick={() => {
